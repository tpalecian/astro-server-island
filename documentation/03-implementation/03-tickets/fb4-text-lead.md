...
**Description:**
Implement the `text_lead` block module mapped by `_modelApiKey`.

**Outcome we expect:**
The `text_lead` block renders with props only and matches design intent.
...
**Legacy component:** `2022-site/components/Content/TextLead.vue`

**Design system:** Use `@rotate/design-system` tokens for typography, spacing, and layout.

**Figma:** TODO — add Figma URL for `Block — Text Lead`.

## 3. Delivery Plan (how)

**Steps:**
1. Create module component for `text_lead`.
...
| # | Criterion | Done |
|---|---|---|
| AC1 | `text_lead` module renders without data fetching. | |
...
- Legacy: `2022-site/components/Content/TextLead.vue`

## 6. Notes

- Pretitle + structured text + size variant.
