...
**Description:**
Implement the `quote` block module mapped by `_modelApiKey`.

**Outcome we expect:**
The `quote` block renders with props only and matches design intent.
...
**Legacy component:** `2022-site/components/Content/TextQuote.vue`

**Design system:** Use `@rotate/design-system` tokens for typography, spacing, and layout.

**Figma:** TODO — add Figma URL for `Block — Quote`.

## 3. Delivery Plan (how)

**Steps:**
1. Create module component for `quote`.
...
| # | Criterion | Done |
|---|---|---|
| AC1 | `quote` module renders without data fetching. | |
...
- Legacy: `2022-site/components/Content/TextQuote.vue`

## 6. Notes

- Quote text + name + information fields.
