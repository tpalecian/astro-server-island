...
**Description:**
Implement the `StudioRecord` block module mapped by `_modelApiKey`.

**Outcome we expect:**
The `StudioRecord` block renders with props only and matches design intent.
...
**Legacy component:** `2022-site/gql/fragments/inline-blocks.gql.js (onStudioRecord)`

**Design system:** Use `@rotate/design-system` tokens for typography, spacing, and layout.

**Figma:** TODO — add Figma URL for `Inline Block — Studio`.

## 3. Delivery Plan (how)

**Steps:**
1. Create module component for `StudioRecord`.
...
| # | Criterion | Done |
|---|---|---|
| AC1 | `StudioRecord` module renders without data fetching. | |
...
- Legacy: `2022-site/gql/fragments/inline-blocks.gql.js (onStudioRecord)`

## 6. Notes

- Inline link to studio record (slug + title).
