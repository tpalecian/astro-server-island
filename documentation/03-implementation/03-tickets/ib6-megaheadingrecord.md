---
title: Inline Block — Mega Heading
...
**Description:**
Implement the `MegaHeadingRecord` block module mapped by `_modelApiKey`.

**Outcome we expect:**
The `MegaHeadingRecord` block renders with props only and matches design intent.
...
**Legacy component:** `2022-site/gql/fragments/inline-blocks.gql.js (onMegaHeadingRecord)`

**Design system:** Use `@rotate/design-system` tokens for typography, spacing, and layout.

**Figma:** TODO — add Figma URL for `Inline Block — Mega Heading`.

## 3. Delivery Plan (how)

**Steps:**
1. Create module component for `MegaHeadingRecord`.
...
| # | Criterion | Done |
|---|---|---|
| AC1 | `MegaHeadingRecord` module renders without data fetching. | |
...
- Legacy: `2022-site/gql/fragments/inline-blocks.gql.js (onMegaHeadingRecord)`

## 6. Notes

- Large inline heading text.
