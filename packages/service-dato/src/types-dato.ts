...
export type ImgixParamsBgRemoveFgType = 'auto' | 'car'

export type ImgixParamsBlendAlign = 'bottom' | 'center' | 'left' | 'middle' | 'right' | 'top'

export type ImgixParamsBlendCrop = 'bottom' | 'faces' | 'left' | 'right' | 'top'
...
export type ImgixParamsCs = 'adobergb1998' | 'origin' | 'srgb' | 'strip' | 'tinysrgb'

export type ImgixParamsFill = 'blur' | 'gen' | 'generative' | 'gradient' | 'solid'

export type ImgixParamsFillGenPos = 'bottom' | 'center' | 'left' | 'middle' | 'right' | 'top'

export type ImgixParamsFillGradientCs = 'hsl' | 'lch' | 'linear' | 'oklab' | 'srgb'

export type ImgixParamsFillGradientLinearDirection = 'bottom' | 'left' | 'right' | 'top'
...
export type ImgixParamsMarkAlign = 'bottom' | 'center' | 'left' | 'middle' | 'right' | 'top'
...
export type ImgixParamsRotType = 'pivot' | 'straighten'

export type ImgixParamsTransparency = 'grid'

export type ImgixParamsTrim = 'alpha' | 'auto' | 'color'

export type ImgixParamsTxtAlign = 'bottom' | 'center' | 'left' | 'middle' | 'right' | 'top'
...
export type LinkModelRecordField =
	| CategoryRecord
	| InfoPageRecord
	| StudioRecord
	| ThinkingRecord
...
export type QuoteModelTextLinksField =
	| EmojiRecord
	| MegaHeadingRecord
	| StudioRecord
	| TagRecord
...
export type StudioModelContentField =
	| CardSliderRecord
	| MediaMultipleRecord
	| MediaSingleRecord
	| QuoteRecord
...
export type TextHalfModelTextLinksField =
	| EmojiRecord
	| MegaHeadingRecord
	| StudioRecord
	| TagRecord
...
export type TextLeadModelTextLinksField =
	| EmojiRecord
	| MegaHeadingRecord
	| StudioRecord
	| TagRecord
...
export type ThinkingModelContentField =
	| CardSliderRecord
	| MediaMultipleRecord
	| MediaSingleRecord
	| QuoteRecord
...
export type WorkModelContentField =
	| CardSliderRecord
	| MediaMultipleRecord
	| MediaSingleRecord
	| QuoteRecord
...
export type AllStudiosCategoryCardsQuery = {
	allStudios: Array<{
		card?: {
			...
			doubleWidth?: any | null
			useHeroImage?: any | null
			copy?: string | null
			hasDarkText?: any | null
			type: string
...
export type AllThinkingsCategoryCardsQuery = {
	allThinkings: Array<{
		card?: {
			id: any
			cardType?: string | null
...
export type AllWorksCategoryCardsQuery = {
	allWorks: Array<{
		card?: {
			id: any
			cardType?: string | null
...
export type CategoryBySlugQuery = {
	category?: {
		...
		seoMetaTags: Array<{ attributes?: any | null; tag: string; content?: string | null }>
	} | null
}

export type OnQuoteRecordFragment = {
	name?: string | null
	id: any
	info?: string | null
	type: string
...
export type OnTextHalfRecordFragment = {
	id: any
	type: string
	copy?: {
		value: any
...
export type OnTextLeadRecordFragment = {
...
export type OnMediaSingleRecordFragment = {
	ratio?: string | null
	displayType?: string | null
	caption?: string | null
	id: any
	isFullscreen?: any | null
	type: string
	media?: {
		url: string
		alt?: string | null
...
export type OnMediaMultipleRecordFragment = {
	ratio?: string | null
...
export type OnCardSliderRecordFragment = {
	speed?: any | null
...
export type OnStatsRecordFragment = {
	id: any
	type: string
	stats: Array<{ value?: string | null; unit?: string | null; label?: string | null }>
}

export type OnTagRecordFragment = {
	id: any
	name?: string | null
	type: 'TagRecord'
	cards: Array<{
...
export type OnEmojiRecordFragment = {
	id: any
	title?: string | null
	type: 'EmojiRecord'
	media?: {
...
export type OnWorkRecordFragment = {
	id: any
	slug?: string | null
	title?: string | null
	type: 'WorkRecord'
...
export type OnThinkingRecordFragment = {
	id: any
	slug?: string | null
	title?: string | null
	type: 'ThinkingRecord'
...
export type OnStudioRecordFragment = {
	id: any
	slug?: string | null
	title?: string | null
	type: 'StudioRecord'
...
export type OnMegaHeadingRecordFragment = {
	id: any
	title?: string | null
	type: 'MegaHeadingRecord'
}
...
export type SeoHomepageFragment = {
	seo?: {
		title?: string | null
		description?: string | null
		image?: {
...
export type GlobalsQuery = {
	homepage?: { backgroundColor?: { hex: string } | null } | null
	popUp?: {
		title?: string | null
		ctaCopy?: string | null
		popUpDelay?: any | null
...
export type HomeQuery = {
	homepage?: {
		...
		heroWords: Array<{ word?: string | null }>
		heroVideo?: {
			url: string
			alt?: string | null
			width?: any | null
...
export type HomepageCardSliderQuery = {
	homepage?: {
		slug?: string | null
		title?: string | null
		content: Array<
...
export type NavigationFooterQuery = {
	navigation?: {
		ctaCopy?: string | null
		ctaLink?: {
			text?: string | null
...
export type RedirectsQuery = {
	allRedirects: Array<{ to?: string | null; from?: string | null; redirectType?: string | null }>
}
...
export type RoutesQuery = {
	...
	infoPage?: { slug?: string | null; type: string } | null
	allCategories: Array<{ slug?: string | null; type: string }>
}
...
export type StudioBySlugQuery = {
	studio?: {
		...
		client?: { name?: string | null; site?: string | null } | null
		heroTitle?: {
			value: any
			links: Array<{
				id: any
...
export type ThinkingBySlugQuery = {
	thinking?: {
		title?: string | null
